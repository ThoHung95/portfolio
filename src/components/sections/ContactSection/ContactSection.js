...
function ContactForm() {
  ...
  function onSubmit() {
    ...
    sendForm(form).then((isSentCorrectly) => {
...
function ContactSection() {
  ...
  const { hasCopied, onCopy } = useClipboard("ntlhungnuce@gmail.com");
            ...
            >
              ...
              >
                ...
                <Tooltip label="GitHub" hasArrow>
                  <Link href="https://github.com/ThoHung95" target="_blank">
                    <IconButton
                      aria-label="github"
                      variant="ghost"
                      size="lg"
                ...
                <Tooltip label="Facebook" hasArrow>
                  <Link
                    href="https://www.facebook.com/but.macquantut"
                    target="_blank"
                  >
                    <IconButton
